...
inline fun <reified T> androidx.fragment.app.Fragment.startActivity(data: (intent: Intent) -> Unit) {
    activity?.startActivity<T>(data)
}

inline fun <reified T> androidx.fragment.app.Fragment.startActivityForResult(requestCode: Int) {
...
inline fun <reified T> androidx.fragment.app.Fragment.startActivityForResult(data: (intent: Intent) -> Unit, requestCode: Int) {
